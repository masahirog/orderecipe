...
class SmaregiTradingHistory < ApplicationRecord
  ...
  #             analysis_category_hash[bumon_id][:zeinuki_uriage] += ex_tax_sales_amount
  #             analysis_category_hash[bumon_id][:net_sales_amount] += nebikigokei
  #             analysis_category_hash[bumon_id][:sales_number] += number
  #             analysis_category_hash[bumon_id][:sales_amount] += nebikimaekei
  #             analysis_category_hash[bumon_id][:discount_amount] += nebiki
  #
  #           else
  #             total_number_sales_sozai -= number if bumon_id == "1"
  #             hash[hinban][:sales_number] -= number
