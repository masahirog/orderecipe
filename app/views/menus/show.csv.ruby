require 'csv'
CSV.generate do |csv|
  csv_column_names = %w(menu_id menu_name recipe serving_memo material_id material_name amount_used unit used_cost preparation post vendor)
    ...
    menu_materials.each_with_index do |menu_material,i|
      if i==0
        csv_column_values = [
          ...
          menu_material.material.calculated_unit,
