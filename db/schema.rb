...
ActiveRecord::Schema.define(version: 2024_11_24_073037) do
  ...
  create_table "analysis_categories", charset: "utf8mb4", collation: "utf8mb4_0900_ai_ci", force: :cascade do |t|
  ...
  create_table "analysis_products", charset: "utf8mb4", collation: "utf8mb4_0900_ai_ci", force: :cascade do |t|
    t.bigint "analysis_id"
  ...
  create_table "brands", charset: "utf8mb3", options: "ENGINE=InnoDB ROW_FORMAT=DYNAMIC", force: :cascade do |t|
  ...
  create_table "buppan_schedules", charset: "utf8mb3", options: "ENGINE=InnoDB ROW_FORMAT=DYNAMIC", force: :cascade do |t|
    t.date "date"
  ...
  create_table "common_product_parts", charset: "utf8mb4", collation: "utf8mb4_0900_ai_ci", force: :cascade do |t|
  ...
  create_table "containers", charset: "utf8mb3", options: "ENGINE=InnoDB ROW_FORMAT=DYNAMIC", force: :cascade do |t|
    t.string "name"
    t.datetime "created_at", null: false
    t.datetime "updated_at", null: false
    t.integer "group_id", null: false
  ...
  create_table "customer_opinions", charset: "utf8mb3", force: :cascade do |t|
    t.date "date"
  ...
  create_table "daily_item_stores", charset: "utf8mb3", options: "ENGINE=InnoDB ROW_FORMAT=DYNAMIC", force: :cascade do |t|
  ...
  create_table "daily_items", charset: "utf8mb4", collation: "utf8mb4_0900_ai_ci", force: :cascade do |t|
  ...
  create_table "daily_menu_details", charset: "utf8mb4", collation: "utf8mb4_0900_ai_ci", force: :cascade do |t|
  ...
  create_table "default_shifts", charset: "utf8mb3", options: "ENGINE=InnoDB ROW_FORMAT=DYNAMIC", force: :cascade do |t|
    t.integer "weekday"
    t.integer "store_id"
    t.integer "staff_id"
  ...
  create_table "fax_mails", charset: "utf8mb3", force: :cascade do |t|
    t.integer "order_id"
    t.integer "vendor_id"
  ...
  create_table "fix_shift_pattern_shift_frames", charset: "utf8mb3", force: :cascade do |t|
    t.integer "fix_shift_pattern_id"
  ...
  create_table "fix_shift_pattern_stores", charset: "utf8mb3", options: "ENGINE=InnoDB ROW_FORMAT=DYNAMIC", force: :cascade do |t|
  ...
  create_table "fix_shift_patterns", charset: "utf8mb3", options: "ENGINE=InnoDB ROW_FORMAT=DYNAMIC", force: :cascade do |t|
  ...
  create_table "food_additives", id: :integer, charset: "utf8mb3", force: :cascade do |t|
    t.string "name"
    t.datetime "created_at", null: false
    t.datetime "updated_at", null: false
  end

  create_table "food_ingredients", id: :integer, charset: "utf8mb3", force: :cascade do |t|
  ...
  create_table "groups", charset: "utf8mb3", options: "ENGINE=InnoDB ROW_FORMAT=DYNAMIC", force: :cascade do |t|
    t.string "name"
    t.datetime "created_at", null: false
    t.datetime "updated_at", null: false
  ...
  create_table "item_expiration_dates", charset: "utf8mb4", collation: "utf8mb4_0900_ai_ci", force: :cascade do |t|
  ...
  create_table "item_order_items", charset: "utf8mb4", collation: "utf8mb4_0900_ai_ci", force: :cascade do |t|
  ...
  create_table "item_orders", charset: "utf8mb4", collation: "utf8mb4_0900_ai_ci", force: :cascade do |t|
  ...
  create_table "item_store_stocks", charset: "utf8mb4", collation: "utf8mb4_0900_ai_ci", force: :cascade do |t|
    t.date "date"
    t.bigint "item_id", null: false
    t.bigint "store_id", null: false
  ...
  create_table "item_varieties", charset: "utf8mb4", collation: "utf8mb4_0900_ai_ci", force: :cascade do |t|
  ...
  create_table "item_vendors", charset: "utf8mb3", options: "ENGINE=InnoDB ROW_FORMAT=DYNAMIC", force: :cascade do |t|
    t.string "store_name"
  ...
  create_table "manual_directories", charset: "utf8mb3", options: "ENGINE=InnoDB ROW_FORMAT=DYNAMIC", force: :cascade do |t|
    t.string "title"
    t.string "ancestry"
    t.datetime "created_at", precision: 6, null: false
    t.datetime "updated_at", precision: 6, null: false
  ...
  create_table "manuals", charset: "utf8mb3", options: "ENGINE=InnoDB ROW_FORMAT=DYNAMIC", force: :cascade do |t|
  ...
  create_table "material_cut_patterns", charset: "utf8mb3", options: "ENGINE=InnoDB ROW_FORMAT=DYNAMIC", force: :cascade do |t|
  ...
  create_table "material_food_additives", id: :integer, charset: "utf8mb3", force: :cascade do |t|
    t.integer "material_id", null: false
  ...
  create_table "material_store_orderables", charset: "utf8mb3", options: "ENGINE=InnoDB ROW_FORMAT=DYNAMIC", force: :cascade do |t|
    t.integer "material_id", null: false
    t.integer "store_id", null: false
  ...
  create_table "menu_cook_checks", charset: "utf8mb3", options: "ENGINE=InnoDB ROW_FORMAT=DYNAMIC", force: :cascade do |t|
  ...
  create_table "menu_last_processes", charset: "utf8mb3", force: :cascade do |t|
    t.integer "menu_id", null: false
    t.string "content", default: "", null: false
    t.string "memo"
    t.datetime "created_at", null: false
  ...
  create_table "menu_materials", id: :integer, charset: "utf8mb4", collation: "utf8mb4_0900_ai_ci", force: :cascade do |t|
    t.integer "menu_id", null: false
    t.integer "material_id", null: false
  ...
  create_table "menu_processes", charset: "utf8mb3", options: "ENGINE=InnoDB ROW_FORMAT=DYNAMIC", force: :cascade do |t|
    t.integer "menu_id"
    t.string "image"
    t.text "memo"
    t.datetime "created_at", precision: 6, null: false
  ...
  create_table "monthly_stocks", charset: "utf8mb3", options: "ENGINE=InnoDB ROW_FORMAT=DYNAMIC", force: :cascade do |t|
    t.date "date"
  ...
  create_table "order_materials", id: :integer, charset: "utf8mb4", collation: "utf8mb4_0900_ai_ci", force: :cascade do |t|
    t.integer "order_id"
  ...
  create_table "order_products", id: :integer, charset: "utf8mb3", force: :cascade do |t|
  ...
  create_table "product_menus", id: :integer, charset: "utf8mb3", force: :cascade do |t|
    t.integer "product_id", null: false
    t.integer "menu_id", null: false
    t.integer "row_order", default: 0, null: false
    t.datetime "created_at", null: false
  ...
  create_table "product_ozara_serving_informations", charset: "utf8mb3", force: :cascade do |t|
    t.integer "product_id", null: false
    t.integer "row_order", default: 0, null: false
    t.string "image"
    t.text "content"
  ...
  create_table "product_pack_serving_informations", charset: "utf8mb4", collation: "utf8mb4_0900_ai_ci", force: :cascade do |t|
    t.integer "product_id", null: false
    t.integer "row_order", default: 0, null: false
    t.string "image"
    t.text "content"
  ...
  create_table "product_parts", charset: "utf8mb4", collation: "utf8mb4_0900_ai_ci", force: :cascade do |t|
    t.integer "product_id", null: false
    t.string "name", default: "", null: false
  ...
  create_table "product_sales_potentials", charset: "utf8mb3", force: :cascade do |t|
    t.integer "store_id", null: false
    t.integer "product_id", null: false
  ...
  create_table "refund_supports", charset: "utf8mb3", force: :cascade do |t|
  ...
  create_table "reminder_template_stores", charset: "utf8mb3", options: "ENGINE=InnoDB ROW_FORMAT=DYNAMIC", force: :cascade do |t|
  ...
  create_table "reminder_templates", charset: "utf8mb4", collation: "utf8mb4_0900_ai_ci", force: :cascade do |t|
  ...
  create_table "sales_report_staffs", charset: "utf8mb4", collation: "utf8mb4_0900_ai_ci", force: :cascade do |t|
  ...
  create_table "serving_plates", charset: "utf8mb3", force: :cascade do |t|
    t.string "name"
    t.string "image"
    t.integer "color"
    t.integer "shape"
  ...
  create_table "shift_frames", charset: "utf8mb3", force: :cascade do |t|
    t.integer "group_id"
    t.string "name"
    t.datetime "created_at", null: false
    t.datetime "updated_at", null: false
  ...
  create_table "shift_patterns", charset: "utf8mb3", force: :cascade do |t|
    t.string "pattern_name"
    t.datetime "created_at", null: false
    t.datetime "updated_at", null: false
    t.integer "group_id"
  ...
  create_table "smaregi_member_products", charset: "utf8mb3", options: "ENGINE=InnoDB ROW_FORMAT=DYNAMIC", force: :cascade do |t|
    t.integer "kaiin_id"
    t.integer "product_id"
  ...
  create_table "smaregi_members", charset: "utf8mb3", force: :cascade do |t|
  ...
  create_table "smaregi_trading_histories", charset: "utf8mb3", force: :cascade do |t|
    t.date "date"
  ...
  create_table "stocks", id: :integer, charset: "utf8mb4", collation: "utf8mb4_0900_ai_ci", force: :cascade do |t|
    t.integer "material_id"
    t.date "date", null: false
  ...
  create_table "store_daily_menu_detail_histories", charset: "utf8mb3", options: "ENGINE=InnoDB ROW_FORMAT=DYNAMIC", force: :cascade do |t|
  ...
  create_table "store_daily_menu_details", charset: "utf8mb4", collation: "utf8mb4_0900_ai_ci", force: :cascade do |t|
  ...
  create_table "store_daily_menu_photos", charset: "utf8mb3", force: :cascade do |t|
    t.integer "store_daily_menu_id", null: false
    t.string "image"
    t.datetime "created_at", null: false
    t.datetime "updated_at", null: false
  ...
  create_table "store_daily_menus", charset: "utf8mb4", collation: "utf8mb4_0900_ai_ci", force: :cascade do |t|
  ...
  create_table "store_shift_frames", charset: "utf8mb3", options: "ENGINE=InnoDB ROW_FORMAT=DYNAMIC", force: :cascade do |t|
    t.integer "store_id", null: false
  ...
  create_table "task_comments", charset: "utf8mb3", options: "ENGINE=InnoDB ROW_FORMAT=DYNAMIC", force: :cascade do |t|
  ...
  create_table "task_images", charset: "utf8mb3", options: "ENGINE=InnoDB ROW_FORMAT=DYNAMIC", force: :cascade do |t|
    t.integer "task_id", null: false
    t.string "image"
    t.datetime "created_at", precision: 6, null: false
    t.datetime "updated_at", precision: 6, null: false
  ...
  create_table "task_staffs", charset: "utf8mb3", options: "ENGINE=InnoDB ROW_FORMAT=DYNAMIC", force: :cascade do |t|
    t.integer "task_id", null: false
    t.integer "staff_id", null: false
  ...
  create_table "task_stores", charset: "utf8mb3", options: "ENGINE=InnoDB ROW_FORMAT=DYNAMIC", force: :cascade do |t|
    t.integer "task_id"
    t.integer "store_id"
  ...
  create_table "tasks", charset: "utf8mb3", options: "ENGINE=InnoDB ROW_FORMAT=DYNAMIC", force: :cascade do |t|
    t.string "title"
    t.text "content"
    t.integer "status"
    t.string "drafter"
  ...
  create_table "temporary_menu_materials", charset: "latin1", options: "ENGINE=InnoDB ROW_FORMAT=DYNAMIC", force: :cascade do |t|
    ...
    t.string "memo", collation: "utf8mb3_general_ci"
    t.index ["date", "menu_material_id"], name: "index_temporary_menu_materials_on_date_and_menu_material_id", unique: true
  end

  create_table "temporary_product_menus", charset: "utf8mb4", collation: "utf8mb4_0900_ai_ci", force: :cascade do |t|
  ...
  create_table "to_store_message_stores", charset: "utf8mb3", options: "ENGINE=InnoDB ROW_FORMAT=DYNAMIC", force: :cascade do |t|
  ...
  create_table "to_store_messages", charset: "utf8mb3", options: "ENGINE=InnoDB ROW_FORMAT=DYNAMIC", force: :cascade do |t|
    t.date "date"
    t.text "content"
    t.datetime "created_at", precision: 6, null: false
    t.datetime "updated_at", precision: 6, null: false
  ...
  create_table "working_hour_work_types", charset: "utf8mb4", collation: "utf8mb4_0900_ai_ci", force: :cascade do |t|
  ...
  create_table "working_hours", charset: "utf8mb4", collation: "utf8mb4_0900_ai_ci", force: :cascade do |t|
    t.bigint "store_id"
    t.bigint "staff_id"
    t.date "date"
